...
Xuất phát từ những phân tích thực tiễn và công nghệ nêu trên, đề tài \textbf{"Xây dựng Ứng dụng Lập Lịch trình và Khám phá Du lịch Miền Trung Thông minh (WanderWise)"} được lựa chọn thực hiện nhằm mang lại một giải pháp công nghệ toàn diện, thẩm mỹ và hiệu quả cho du khách.

\begin{ghinho}
WanderWise không chỉ là một ứng dụng tra cứu thông tin tĩnh mà là một trợ lý du lịch số toàn diện (\en{All-in-One Smart Travel Companion}), tích hợp khả năng lập lịch trình tự thích ứng theo ngân sách, sở thích, thời tiết và hỗ trợ tiện ích tài chính nhóm.
\end{ghinho}
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Thu thập, làm giàu và chuẩn hóa dữ liệu du lịch thực tế tại 9 tỉnh/thành phố trọng điểm Miền Trung (Đà Nẵng, Quảng Bình, Quảng Nam, Thừa Thiên Huế, Bình Định, Phú Yên, Khánh Hòa, Lâm Đồng, Gia Lai).
...
\begin{itemize}
    \item \textbf{Đối tượng người dùng:} Khách du lịch nội địa và quốc tế có nhu cầu du lịch tự túc cá nhân hoặc theo nhóm tại khu vực Miền Trung Việt Nam.
    \item \textbf{Phạm vi địa lý:} Khảo sát và tích hợp dữ liệu du lịch tại 9 tỉnh/thành phố: Đà Nẵng, Quảng Bình, Hội An (Quảng Nam), Huế (Thừa Thiên Huế), Quy Nhơn (Bình Định), Phú Yên, Nha Trang (Khánh Hòa), Đà Lạt (Lâm Đồng), Gia Lai.
