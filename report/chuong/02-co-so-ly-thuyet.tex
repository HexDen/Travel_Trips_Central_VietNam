...
Trong đồ án WanderWise, nhóm lựa chọn mô hình \textbf{Google Gemini 2.5 Flash API}:
\begin{itemize}
...
Một câu lệnh hoàn chỉnh trong hệ thống WanderWise bao gồm 4 thành phần thiết yếu:
\begin{enumerate}
...
\begin{itemize}
    ...
    \item Hệ thống WanderWise sử dụng thông số \code{precipitation\_probability} để kích hoạt tính năng thông minh \textit{Đổi lịch tránh mưa tự động} khi xác suất mưa vượt quá $60\%$.
\end{itemize}
...
\begin{table}[H]
\centering
\caption{Bảng so sánh tính năng giữa WanderWise và các nền tảng du lịch hiện hữu}
\label{tab:comparison}
\resizebox{\textwidth}{!}{
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Tính năng} & \textbf{Google Travel} & \textbf{Traveloka / Trip.com} & \textbf{Chatbot ChatGPT} & \textbf{WanderWise (Đề tài)} \\ \hline
...
\begin{luuy}
Các chatbot AI tổng quát (như ChatGPT bản miễn phí) khi được yêu cầu lập lịch trình du lịch thường chỉ sinh ra các đoạn văn bản dài khó đọc, không có địa chỉ số nhà cụ thể, không có hình ảnh minh họa và không thể tương tác trực quan (chọn điểm, lưu lịch trình, chia tiền). WanderWise khắc phục triệt để các nhược điểm này.
\end{luuy}
